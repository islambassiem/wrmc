<header
    class="sticky top-0 bg-white h-32 flex w-full border-gray-200 z-50 dark:border-gray-800 dark:bg-gray-900 xl:border-b"
    x-data="{
    ...
    <div class="flex flex-col items-center justify-between grow xl:flex-row xl:px-6">
        <div
            ...
            <a href="/" class="xl:hidden">
                <img class="dark:hidden" src="/assets/logo.gif" alt="Logo" style="max-height: 60px;"/>
            </a>
