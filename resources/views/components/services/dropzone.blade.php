<div x-data="{
    ...
    class="transition mt-8 border border-gray-300 border-dashed cursor-pointer dark:hover:border-brand-500 dark:border-gray-700 rounded-xl hover:border-brand-500">
    <div @drop.prevent="handleDrop($event)" @dragover.prevent="isDragging = true"
        @dragleave.prevent="isDragging = false" @click="$refs.fileInput.click()" :class="isDragging
        ...
        <div class="flex flex-col items-center m-0">
            <!-- Icon Container -->
            <div class="mb-5.5 flex justify-center">
                <div
                    class="flex h-17 w-17 items-center justify-center rounded-full bg-gray-200 text-gray-700 dark:bg-gray-800 dark:text-gray-400">
            ...
            <span class="text-center mb-5 block w-full max-w-72.5 text-sm text-gray-700 dark:text-gray-400">
