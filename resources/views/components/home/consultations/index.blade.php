...
<section class="container mx-auto bg-violet-50/50 min-h-96 mb-10 border-t-2 border-t-violet-600">
    <div class="max-w-6xl flex flex-col lg:flex-row justify-around items-center">
        {{-- Left --}}
        <div class="flex-1 m-10">
            {{-- badge --}}
            <div
                class="inline-flex items-center gap-1.5 bg-violet-50 text-violet-800 border border-violet-400 text-sm font-semibold py-2.5 px-3 rounded-3xl mb-3.5 tracking-wide">
                ✦ Now at WRMC
            </div>

            <h2 class="text-3xl font-bold">Specialist consultations — <br><span class="text-violet-600">closer to home for
                    Logan families</span></h2>
            <p class="text-lg py-4 text-justify text-violet-950">WRMC is now accepting specialist referrals from GPs and
            ...
            <div class="flex flex-col lg:flex-row gap-5 mt-10">
                <a
                    href="#"
                    class="flex items-center justify-center grow gap-2 rounded-xl border bg-violet-700 text-white font-bold text-lg h-12 p-y-3  duration-300 hover:bg-violet-800  hover:-translate-y-1"
                >
                ...
                <a
                    href="#"
                    class="flex items-center justify-center grow gap-2 rounded-xl border border-violet-600 text-violet-950 font-bold text-lg h-12 p-y-3   duration-300 hover:-translate-y-1"
                >
        ...
        {{-- Right --}}
        <div class="bg-white shrink-0 w-80 my-10 p-4 shadow-sm rounded-xl border border-violet-400">
            {{-- Title --}}
            <p class="flex items-center gap-3 mb-5">
                <img src="https://s.w.org/images/core/emoji/17.0.2/svg/1f3e5.svg" alt="health-professionals"
                    class="size-5">
                <span class="uppercase tracking-wide text-violet-700 font-semibold text-base">For GPs & Health
                    Professionals</span>
            </p>
            ...
            <div class="border-b border-violet-100 "></div>
