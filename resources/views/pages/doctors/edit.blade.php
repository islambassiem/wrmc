...
@section('content')
    ...
    {{-- Page Header --}}
    <div class="mb-8">
        <h1 class="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-white">Edit a Doctor</h1>
        ...
        <div
            ...
            <div class="p-6 grid grid-cols-1 sm:grid-cols-2 gap-5">
                ...
                <div>
                    ...
                    <input type="text" id="title" name="title" value="{{ old('title', $doctor->title) }}"
                        placeholder="e.g. MD, FACS, PhD"
                ...
                <div class="sm:col-span-2">
                    ...
                    <input type="text" id="field_of_expertise" name="field_of_expertise"
                        value="{{ old('field_of_expertise', $doctor->field_of_expertise) }}"
            ...
            <div class="p-6 grid grid-cols-1 sm:grid-cols-2 gap-5">
                ...
                <div class="sm:col-span-2 lg:col-span-1">
                    ...
                    <div class="relative max-w-sm">
                        ...
                        <input datepicker datepicker-format="yyyy-mm-dd" id="start-datepicker" type="text" name="joining_date" value="{{ old('joining_date', $doctor->joining_date) }}"
                ...
                <div class="sm:col-span-2 lg:col-span-1">
                    ...
                    <div class="relative max-w-sm">
                        ...
                        <input datepicker datepicker-format="yyyy-mm-dd" id="resignation-datepicker" type="text" name="resignation_date" value="{{ $doctor->resignation_date }}"
                            class="block w-full ps-9 pe-3  bg-neutral-secondary-medium border border-default-medium text-heading text-sm rounded-base focus:ring-brand focus:border-brand px-3 py-2.5 shadow-xs placeholder:text-body"
                            placeholder="Select date">
                    </div>
            ...
            <div class="p-6 grid grid-cols-1 sm:grid-cols-2 gap-5">
                ...
                <div>
                    ...
                    <input type="tel" id="mobile_phone" name="mobile_phone"
                        value="{{ old('mobile_phone', $doctor->mobile_phone) }}" placeholder="+1 (555) 000-0000"
                ...
                <div>
                    ...
                    <input type="tel" id="office_phone" name="office_phone"
                        value="{{ old('office_phone', $doctor->office_phone) }}" placeholder="+1 (555) 000-0001"
            ...
            <div class="p-6 space-y-5">
                ...
                <div>
                    ...
                    <div class="flex flex-col sm:flex-row items-start sm:items-center gap-4">
                        ...
                        <div id="image-preview"
                            class="shrink-0 w-24 h-24 rounded-2xl border-2 border-dashed border-gray-300 dark:border-gray-700 bg-gray-50 dark:bg-gray-800 flex items-center justify-center overflow-hidden">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="text" id="quote" name="quote" value="{{ old('quote', $doctor->quote) }}"
