            ...
            <div class="p-6 grid grid-cols-1 sm:grid-cols-2 gap-5">
                ...
                <div class="sm:col-span-2 lg:col-span-1">
                    ...
                    <div class="relative max-w-sm">
                        ...
                        <input datepicker datepicker-format="yyyy-mm-dd" id="start-datepicker" type="text"
                            name="joining_date" value="{{ old('joining_date', $doctor->joining_date) }}"
                ...
                <div class="sm:col-span-2 lg:col-span-1">
                    ...
                    <div class="relative max-w-sm">
                        ...
                        <input datepicker datepicker-format="yyyy-mm-dd" id="resignation-datepicker" type="text"
                            name="resignation_date" value="{{ $doctor->resignation_date }}"
                            class="block w-full ps-9 pe-3  bg-neutral-secondary-medium border border-default-medium text-heading text-sm rounded-base focus:ring-brand focus:border-brand px-3 py-2.5 shadow-xs placeholder:text-body"
                            placeholder="Select date">
                    </div>
...
@push('scripts')
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            editor.root.innerHTML = @json(old('bio', $doctor->bio));
